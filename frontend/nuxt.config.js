  ...
  */
  head: {
    ...
    meta: [
      ...
      { hid: 'og:title', property: 'og:title', content: 'atsumorichannel.net' },
      { hid: 'og:type', property: 'og:type', content: 'website'},
      { hid: 'og:image', property: 'og:image', content: ' https://i.imgur.com/AwVDuYf.png' },
      { hid: 'twitter:site', name: 'twitter:site', content: '@AtsumoriCh' },
      { hid: 'twitter:card', name: 'twitter:card', content: 'summary' },
      { hid: 'og:site_name', property: 'og:site_name', content: 'atsumorichannel.net' },
  ...
  */
  modules: [
    ...
    ['@nuxtjs/google-adsense', {
      ...
      pageLevelAds: true,
      analyticsUacct: 'UA-160712550-1',
      analyticsDomainName: 'atsumorichannel.net'
    }]
  ],
